...
setpath_json "product" "extensionsGallery" '{"serviceUrl": "https://marketplace.visualstudio.com/_apis/public/gallery", "cacheUrl":"https://vscode.blob.core.windows.net/gallery/index","itemUrl": "https://marketplace.visualstudio.com/items"}'
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "applicationName" "IDE123-insiders"
  ...
  setpath "product" "applicationName" "IDE123"
  setpath "product" "linuxIconName" "IDE123"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "IDE123"
  setpath "product" "serverApplicationName" "IDE123-server"
